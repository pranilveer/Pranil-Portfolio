...
export default function ReviewCard({ name, role, rating, text }: Review) {
  return (
    <div className="flex flex-col w-full h-full min-h-[320px] sm:min-h-[300px] lg:min-h-[380px] items-start gap-3 sm:gap-3.5 lg:gap-4 p-4 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl lg:rounded-3xl bg-[#FFFFFF]/14 backdrop-blur-[14px] transition-opacity duration-300">
